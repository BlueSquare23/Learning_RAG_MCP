...
def read_techcorp_docs():
    ...
    possible_paths = [
        "/home/blue/Projects/Learning/Learning_RAG_MCP/lab4/techcorp-docs/**/*.md",  # Lab environment
...
def get_doc_info():
    ...
    for i, (doc, path) in enumerate(zip(docs, paths)):
        ...
        rel_path = path.replace("/home/blue/Projects/Learning/Learning_RAG_MCP/lab4/techcorp-docs/", "")
